...
/**
 * This class deals with the logging of the service requests.
...
public class ServiceLogEntry {
    ...
    /**
     * Creates an ArrayList of all the entries the user is involved with, whether they were a requester or fulfiller.
     * @param user The user who has either made or fulfilled requests.
     * @return The ArrayList of ServiceLogEntry's the user is involved in.
     */
    ...
    /**
     * Checks to see if a user is involved as either the fulfiller or requester of a particular ServiceRequest.
     * @param user The user who has either made or fulfilled the request.
     * @param service_request The request that the user either is or is not involved with.
     * @return True if the user is involved as the fulfiller or requester and false if they are not either.
     */
